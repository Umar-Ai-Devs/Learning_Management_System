...
const s: Record<string, React.CSSProperties> = {
  ...
  recentAvatar: { width: 32, height: 32, borderRadius: 8, background: '#ede9fe', color: '#6366f1', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 13, fontWeight: 700, flexShrink: 0 },
