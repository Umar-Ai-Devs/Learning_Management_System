...
class Config:
    ...
    # Database
    SQLALCHEMY_DATABASE_URI = os.environ.get('DATABASE_URL', 'mysql+pymysql://root:@localhost/learning_management_system')
...
class DevelopmentConfig(Config):
    ...
    DEBUG = True
    TESTING = False
    SQLALCHEMY_DATABASE_URI = os.environ.get('DEV_DATABASE_URL', 'mysql+pymysql://root:@localhost/lms_dev')
...
# Configuration dictionary - MUST be defined
config = {
